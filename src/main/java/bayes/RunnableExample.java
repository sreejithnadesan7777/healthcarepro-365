...
public class RunnableExample {
    ...
    public static void main(String[] args) {
         ...
         */
        final String[] positiveText = "claim_id claim_status claim_notes patient_id provider_id medication_id".split("\\s");
         ...
         */
        final String[] unknownText1 = "claim_id claim_stat".split("\\s");
